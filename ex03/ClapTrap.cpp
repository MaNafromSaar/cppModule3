...
/*   Updated: 2025/02/21 15:43:26 by mnaumann         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::attack(ClapTrap &target) {
	...
	EnergyPoints--;
	std::cout << Name << " attacks " << target.Name << " causing " << AttackDamage << " points of damage!" << std::endl;
...
void ClapTrap::beRepaired(unsigned int amount) {
	std::cout << Name << " has been repaired for " << amount << " points!" << std::endl;
	this->HitPoints += amount;
	this->EnergyPoints -= 1;
	std::cout << Name << " has " << HitPoints << " hit points left!" << std::endl;
}
